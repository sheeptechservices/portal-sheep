...
export const CATALOGO: PermGrupo[] = [
  {
    ...
    acoes: [
      { chave: 'oportunidades:ver', label: 'Ver o quadro e abrir cards', acesso: true },
      { chave: 'oportunidades:criar', label: 'Criar oportunidade' },
      ...
      { chave: 'oportunidades:deps', label: 'Consultar o bureau DEPS pelo card' },
      { chave: 'oportunidades:excluir', label: 'Excluir oportunidade' },
    ],
  },
  {
    chave: 'dashboard',
...
export const PERMISSAO_DA_ACAO: Record<string, string | string[]> = {
  ...
  add_entrega_arquivo: 'projetos:editar',
  ...
  reunioes_dados: ['projetos:ver', 'oportunidades:ver'],
  ...
  get_oportunidade_files: 'oportunidades:ver',
  get_file_base64: 'oportunidades:ver',
  get_form_file_base64: 'oportunidades:ver',
  ...
  update_arquivo_categoria: 'oportunidades:anexar',
  delete_file: 'oportunidades:anexo_excluir',
  delete_form_file: 'oportunidades:anexo_excluir',
  delete_stage_file: 'oportunidades:anexo_excluir',
  add_pendencias: 'oportunidades:pendencias',
  toggle_pendencia: 'oportunidades:pendencias',
  update_pendencia: 'oportunidades:pendencias',
  delete_pendencia: 'oportunidades:pendencias',
  ...
  add_nova_oportunidade_notif: 'configuracoes:notificacoes',
  ...
  aws_config: 'configuracoes:integracoes',
  save_aws_key: 'configuracoes:integracoes',
  remove_aws_key: 'configuracoes:integracoes',
