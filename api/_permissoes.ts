...
export const PERMISSAO_DA_ACAO: Record<string, string | string[]> = {
  ...
  fireflies_reunioes: ['projetos:editar', 'leads:editar'],
  fireflies_gravacao: ['projetos:ver', 'leads:ver'],
  reunioes_dados: ['projetos:ver', 'leads:ver'],
  ...
  anexar_reuniao_fireflies_lead: 'leads:editar',
  registrar_reuniao_lead: 'leads:editar',
  excluir_reuniao_lead: 'leads:editar',
  // ── Sempre liberado ────────────────────────────────────────────────────────
  me: LIVRE,
  perfil: LIVRE,
